...
<head>
  ...
  <!-- TailwindCSS (CDN para desarrollo - en producción usar instalación local) -->
  <!-- NOTA: La advertencia en consola sobre "should not be used in production" es normal en desarrollo -->
