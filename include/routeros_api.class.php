...
class RouterosAPI
{
    ...
    public function connect($ip, $login, $password, $port = null)
    {
        ...
        for ($ATTEMPT = 1; $ATTEMPT <= $this->attempts; $ATTEMPT++) {
            ...
            // Establecer un timeout más estricto para el socket
            ...
            if ($this->socket) {
                // Configurar timeout para lectura/escritura
            ...
            // Reducir el delay entre intentos
            if ($ATTEMPT < $this->attempts) {
                usleep($this->delay * 500000); // Usamos usleep para mayor precisión (microsegundos)
            }
        }
